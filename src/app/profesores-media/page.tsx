...
export default function ProfesoresMediaPage() {
      ...
      <section className="py-16">
        <div className="max-w-md mx-auto px-4">
          <div className="bg-white rounded-xl shadow-sm p-8 text-center">
            ...
            <h1 className="font-heading text-2xl font-bold text-dark mb-2">Profesores Media</h1>
    ...
    <section className="py-16">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-bg-light rounded-xl p-8">
          <p className="text-gray text-center">Contenido para profesores de educación media.</p>
        </div>
      </div>
    </section>
  );
